...
![自分のObsidianについて-睡眠時間-Tracker.png](../../images/0002/自分のObsidianについて-睡眠時間-Tracker.png)

人として終わっていることがわかります。

グラフビューで見ると、デイリーノートの大部分がリンクなしで触っていないんだなーってことがわかります。

![自分のObsidianについて-デイリーノートのリンク.png](../../images/0002/自分のObsidianについて-デイリーノートのリンク.png)
...
![自分のObsidianについて-Task-一覧.png](../../images/0002/自分のObsidianについて-Task-一覧.png)
...
![自分のObsidianについて-大学のノート-ディレクトリ.png](../../images/0002/自分のObsidianについて-大学のノート-ディレクトリ.png)
...
![自分のObsidianについて-大学の講義ノート-prefix.png](../../images/0002/自分のObsidianについて-大学の講義ノート-prefix.png)
...
![自分のObsidianについて-物理-図-excalidraw.png](../../images/0002/自分のObsidianについて-物理-図-excalidraw.png)
...
![自分のObsidianについて-プログラミング-ディレクトリ.png](../../images/0002/自分のObsidianについて-プログラミング-ディレクトリ.png)

ノートを見てみるとこんな感じ

![自分のObsidianについて-wikinote-プロパティ-例.png](../../images/0002/自分のObsidianについて-wikinote-プロパティ-例.png)
...
![自分のObsidianについて-noteStutas-一覧表示例.png](../../images/0002/自分のObsidianについて-noteStutas-一覧表示例.png)
...
![自分のObsidianについて-MOC-canvas.png](../../images/0002/自分のObsidianについて-MOC-canvas.png)
...
![自分のObsidianについて-ultraLobster-画面例.png](../../images/0002/自分のObsidianについて-ultraLobster-画面例.png)
...
![自分のObsidianについて-AutoCardLink.png](../../images/0002/自分のObsidianについて-AutoCardLink.png)
...
![自分のObsidianについて-CodeEmitter.png](../../images/0002/自分のObsidianについて-CodeEmitter.png)

### Custom Frames
このプラグインは左側のリボンメニューに各Webサイトへのリンクとブラウザ機能を提供してくれるものです。
自分はよく使用するAIやDeepLをここに入れています。

![自分のObsidianについて-CustomFrames.png](../../images/0002/自分のObsidianについて-CustomFrames.png)
...
![自分のObsidianについて-DataLoom.png](../../images/0002/自分のObsidianについて-DataLoom.png)
...
![自分のObsidianについて-floatingToc.png](../../images/0002/自分のObsidianについて-floatingToc.png)
...
![自分のObsidianについて-HomePage.png](../../images/0002/自分のObsidianについて-HomePage.png)
...
![自分のObsidianについて-Iconize.png](../../images/0002/自分のObsidianについて-Iconize.png)

### Image Toolkit
このプラグインは画像を拡大したり、コピーしたりできるものです。
このクリップボードにコピーする機能だけで使用しているまであります。

![自分のObsidianについて-ImageToolKit.png](../../images/0002/自分のObsidianについて-ImageToolKit.png)

### Marp
Marpは正直、調べてもらった方が速いですが爆速でスライドを作成できるプラグインです。結構サークルのオリエンテーションとかで使用機会が多いです。

![自分のObsidianについて-marp.png](../../images/0002/自分のObsidianについて-marp.png)

### Paste Image Rename
このプラグインは画像をクリップボードから張り付ける際に名前を変更するダイアログを出してくれる優れものです。
このおかげで画像関連の作業量がめちゃ減りました。

![自分のObsidianについて-PasteImageRename.png](../../images/0002/自分のObsidianについて-PasteImageRename.png)
...
![自分のObsidianについて-PeerDraft.png](../../images/0002/自分のObsidianについて-PeerDraft.png)
...
- [ ] リマインドテスト (@2024-10-15 19:35)
 ...
 ![自分のObsidianについて-Reminder.png](../../images/0002/自分のObsidianについて-Reminder.png)
...
![自分のObsidianについて-Surfing.png](../../images/0002/自分のObsidianについて-Surfing.png)

### Task Progress Bar
このプラグインはtaskが入れ子構造になっているときにprogressBarを表示するプラグインです。
プロジェクトや自分でアプリを作る際に進捗がわかっていい感じです。

![自分のObsidianについて-TaskProgressBar.png](../../images/0002/自分のObsidianについて-TaskProgressBar.png)
